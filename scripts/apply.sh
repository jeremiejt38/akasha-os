...
$SCP "$SCRIPT_DIR/system/cec-wakeup.sh" "root@$PI_IP:/storage/.config/cec-wakeup.sh"
$SCP "$SCRIPT_DIR/system/cec-standby.sh" "root@$PI_IP:/storage/.config/cec-standby.sh"
$SCP "$SCRIPT_DIR/system/autostart.sh" "root@$PI_IP:/storage/.config/autostart.sh"
$SCP "$SCRIPT_DIR/system/wifi-silent-agent.py" "root@$PI_IP:/storage/.config/wifi-silent-agent.py"
$SCP "$SCRIPT_DIR/system/wifi-watchdog.sh" "root@$PI_IP:/storage/.config/wifi-watchdog.sh"
$SCP "$SCRIPT_DIR/system/connman/connman_main.conf.example" "root@$PI_IP:/storage/.config/connman_main.conf"
$SCP "$SCRIPT_DIR/system/splash-video.sh" "root@$PI_IP:/storage/splash-video.sh"
...
$SCP "$SCRIPT_DIR/system/system.d/cec-wake-early.service" "root@$PI_IP:/storage/.config/system.d/cec-wake-early.service"
$SCP "$SCRIPT_DIR/system/system.d/splash-video.service" "root@$PI_IP:/storage/.config/system.d/splash-video.service"
...
$SSH "chmod +x /storage/.config/cec-wakeup.sh /storage/.config/cec-standby.sh /storage/splash-video.sh"
$SSH "systemctl daemon-reload && systemctl enable cec-tv.service cec-wakeup.service cec-wake-early.service splash-video.service splash-poweroff.service splash-reboot.service wifi-silent-agent.service && systemctl disable wifi-watchdog.service"
