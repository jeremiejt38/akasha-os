...
$SSH "systemctl daemon-reload && systemctl enable cec-tv.service cec-wakeup.service cec-wake-early.service splash-video.service splash-poweroff.service splash-reboot.service"
